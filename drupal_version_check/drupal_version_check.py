...
class LFSDrupalVersionCheck(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        cls.username = Conf_Reader.get_value(credentials_file, 'LOGIN_USER')
        cls.password = Conf_Reader.get_value(credentials_file, 'LOGIN_PASSWORD')
